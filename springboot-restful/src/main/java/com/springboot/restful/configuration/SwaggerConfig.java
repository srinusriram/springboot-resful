...
public class SwaggerConfig {
	public static final Contact DEFAULT_CONTACT = new Contact("Srinvias Mantrala", "www.srni.com",
			"srinusriram@gmail.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("User API Tittle", "User Api Documentation", "1.0",
